    ...
    <div class="md:w-1/2 p-5">
        <div class="shadow bg-white p-5 mb-5">
            ...
            <form action="{{route('comentario.store', ['post'=>$post, 'user'=>$user])}}"method="POST">
                @csrf
                <div class="mb-5">
                    <label for="comentario" class="md-2 block uppercase text-gray-500 font-bold">Descripción
                        Anade un comentario
                    </label>
                ...
                <input type="submit" value="Comentar" class="bg-sky-600 hover:bg-sky-700 transitions-colors cursor-pointer uppercase font-bold w-full p-4 mt-2 text-white rounded-lg">
            </form>
            @endauth
